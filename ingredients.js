...
window.FRIGO_INGREDIENTS = {
  ...
  fridge: [
    ...
    ['sriracha',        'canned'],
    ['gochujang',       'canned'],
    ['sichuan chilli bean paste', 'canned'],
    ['shaoxing wine',   'canned'],
    ['miso paste',      'canned'],
    ['thai curry paste','canned'],
    ['olives',          'canned'],
    ['pickles',         'canned'],
    ['lemons',          'produce'],
    ['limes',           'produce'],
